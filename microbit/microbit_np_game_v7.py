...
# 定義顏色 (R, G, B) - 亮度已調整為 BRIGHTNESS_FACTOR (40)
# 為了保持顏色比例，只用 40/255 進行縮放
GAMEOVER_COLOR = (BRIGHTNESS_FACTOR, 0, 0) # 紅色
# 敵人 1 生命: 綠色
COLOR_HP1      = (0, BRIGHTNESS_FACTOR, 0)
# 敵人 2 生命: 藍色
COLOR_HP2      = (0, 0, BRIGHTNESS_FACTOR)
# 子彈顏色: 黃色
BULLET_COLOR   = (BRIGHTNESS_FACTOR, BRIGHTNESS_FACTOR, 0)
...
def update_difficulty():
    ...
    if new_level > current_level:
        ...
        # 速度上限檢查 (已調整為 MIN_INTERVAL = 500)
        if current_interval < MIN_INTERVAL:
            current_interval = MIN_INTERVAL

        # 升級時在 Micro:bit 矩陣上顯示等級
